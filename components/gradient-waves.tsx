...
export function GradientWaves({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpeed: { value: prefersReducedMotion ? 0 : 0.4 },
  ...
  useEffect(() => {
    ...
    enableMouseRef.current = mouseInteraction && !prefersReducedMotion

    u.uSpeed.value = prefersReducedMotion ? 0 : speed
    ...
    u.uEnableMouse.value = enableMouseRef.current
