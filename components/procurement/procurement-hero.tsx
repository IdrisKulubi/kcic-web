...
import heroImage from "@/public/procurement/procurement.png"
import { procurementHero } from "@/lib/data/procurement"

export function ProcurementHero() {
  return (
    <section
      className="canvas-panel isolate grid min-h-[min(60svh,38rem)] grid-cols-1 grid-rows-1"
      aria-labelledby="procurement-hero-title"
    >
      <Image
        src={heroImage}
        alt="KCIC procurement and supplier engagement"
        fill
        placeholder="blur"
        sizes="100vw"
        priority
      ...
      <div className="flex flex-col items-center justify-center px-5 py-24 text-center sm:px-8 md:px-[clamp(2rem,5vw,4.25rem)]">
        <p className="m-0 text-[0.7rem] font-medium tracking-[0.18em] text-[#c9dcc4] uppercase">
          {procurementHero.eyebrow}
        </p>
        <h1
          id="procurement-hero-title"
