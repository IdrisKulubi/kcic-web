...
export const relations = defineRelationsPart(
  ...
  (r) => ({
    heroSection: {
      buttons: r.many.heroButtons({
        from: r.heroSection.id,
        to: r.heroButtons.heroId,
      }),
    },
    heroButtons: {
      hero: r.one.heroSection({
        from: r.heroButtons.heroId,
        to: r.heroSection.id,
      }),
    },
    programmes: {
      sponsors: r.many.programmeSponsors({
        from: r.programmes.id,
        to: r.programmeSponsors.programmeId,
      }),
    },
    programmeSponsors: {
      programme: r.one.programmes({
        from: r.programmeSponsors.programmeId,
        to: r.programmes.id,
      }),
    },
    opportunities: {
      attachments: r.many.opportunityAttachments({
        from: r.opportunities.id,
        to: r.opportunityAttachments.opportunityId,
      }),
    },
    opportunityAttachments: {
      opportunity: r.one.opportunities({
        from: r.opportunityAttachments.opportunityId,
